...
async function get_bids_by_cp(query, excludeDraft = false) {
  ...
  bids$ = bids$.map((m, i) => {
    let payload = {
      ...
      "skill_desc": ['CONSULTING', 'FINANCE', 'MANAGEMENT', 'MARKETING', 'TECHNOLOGY', 'OTHER', 'IT', 'HR', 'LEGAL', 'ADMIN', 'COMMUNICATIONS', 'MEDICAL', 'SCIENCE', 'ENGINEERING', 'EDUCATION', 'ECONOMICS', 'POLITICAL', 'SOCIAL', 'ENVIRONMENTAL', 'AGRICULTURE', 'OTHER'][Math.floor(Math.random() * 22)],
      ...
      "ubw_submit_dt": ['08/11/2021', '08/12/2021', '08/13/2021', '08/14/2021', '08/15/2021', '08/16/2021', '08/17/2021', '08/18/2021', '08/19/2021', '08/20/2021'][Math.floor(Math.random() * 10)],
      ...
      "TED": ['01/12/2021', '02/12/2021', '03/12/2021', '04/12/2021', '05/12/2021', '06/12/2021', '07/12/2021', '08/12/2021', '09/12/2021', '10/12/2021'][Math.floor(Math.random() * 10)],
      "userDetails": {
